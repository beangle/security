...
## generate session's protobuf file
    ...
    wget -P ~/bin  https://maven.aliyun.com/repository/public/com/google/protobuf/protoc/4.35.1/protoc-4.35.1-linux-x86_64.exe
    chmod +x ~/bin/protoc-4.35.1-linux-x86_64.exe
