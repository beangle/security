...
public final class Model {
  ...
  public static final class Session extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (ttiMinutes_ != 0) {
        output.writeInt32(6, ttiMinutes_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (ttiMinutes_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(6, ttiMinutes_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + TTIMINUTES_FIELD_NUMBER;
      hash = (53 * hash) + getTtiMinutes();
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    }
    ...
    public static final class Builder extends
      ...
      public org.beangle.security.session.protobuf.Model.Session buildPartial() {
        ...
        result.ttiMinutes_ = ttiMinutes_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(org.beangle.security.session.protobuf.Model.Session other) {
        ...
        if (other.getTtiMinutes() != 0) {
          setTtiMinutes(other.getTtiMinutes());
        }
        this.mergeUnknownFields(other.unknownFields);
        onChanged();
        return this;
       ...
       * <code>int32 ttiMinutes = 6;</code>
       */
      public Builder setTtiMinutes(int value) {
       ...
       * <code>int32 ttiMinutes = 6;</code>
       */
      public Builder clearTtiMinutes() {
