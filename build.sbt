...
ThisBuild / version := "4.3.28-SNAPSHOT"
...
val beangle_serializer = "org.beangle.serializer" % "beangle-serializer" % "0.1.15"
val beangle_cache = "org.beangle.cache" % "beangle-cache" % "0.1.13"
