...
ThisBuild / version := "4.3.24-SNAPSHOT"
...
val beangle_serializer = "org.beangle.serializer" % "beangle-serializer" % "0.1.12"
val beangle_cache = "org.beangle.cache" % "beangle-cache" % "0.1.11"
val beangle_web = "org.beangle.web" % "beangle-web" % "0.5.1"
